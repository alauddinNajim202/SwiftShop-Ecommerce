...
<head>
    ...
    <title>Swift show | E-commerce</title>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/assets/css/demos/demo-14.csscss') }}">
</head>
                    ...
                    <div class="row">
                        <div class="col-auto col-lg-3 col-xl-3 col-xxl-2">
                            ...
                            <a href="index.html" class="logo">
                                <img src="{{ asset('frontend/assets/images/demos/demo-14/logo.png') }}"
                                    alt="Molla Logo" width="105" height="25">
                            </a>
                        </div><!-- End .col-xl-3 col-xxl-2 -->
                        @php
                            $categories = App\Models\Admin\Category::orderBy('order_level')
                                        ...
                                        <div class="dropdown compare-dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <div class="compare-actions">
                                                    ...
                                                    <a href="#"
                                                        class="btn btn-outline-primary-2"><span>Compare</span><i
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <ul>
                                                                                ...
                                                                                <li><a href="#">Digital Memory
                                                                                        Cards</a></li>
                                                                                <li><a href="#">Camera Bags,
                                                                                        Backpacks & Cases</a></li>
                                                                            </ul>
                                                                        </div><!-- End .col-md-6 -->
                                                                    </div><!-- End .row -->
                                                                </div><!-- End .menu-col -->
        ...
        <main class="main mt-3">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    {{-- <div class="col-xl-3 col-xxl-2  d-xxl-block">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-9 col-xxl-10">
                        <div class="row">
                                ...
                                <div class="row mt-2">
                                        ...
                                        <div class="banner banner-overlay">
                                            ...
                                            <div class="banner-content">
                                                <h4 class="banner-subtitle text-white d-none d-sm-block"><a
                                                        href="#">Hottest Deals</a></h4>
                                                <!-- End .banner-subtitle -->
                                                <h3 class="banner-title text-white"><a href="#">Detox And
                                                        Beautify <br>For Spring <br><span>Up To 20% Off</span></a></h3>
                                                <!-- End .banner-title -->
                                    ...
                                    <div class="col-md-6">
                                        <div class="banner banner-overlay">
                                            ...
                                            <div class="banner-content">
                                                <h4 class="banner-subtitle text-white d-none d-sm-block"><a
                                                        href="#">Deal of the Day</a></h4>
                                                <!-- End .banner-subtitle -->
                                                <h3 class="banner-title text-white"><a href="#">Headphones
                            ...
                            <div class="col-12 col-xxl-5col d-none d-xxl-block">
                                <div class="banner banner-overlay">
                                    <a href="#">
                                        <img src="{{ asset('frontend/assets/images/demos/demo-14/banners/banner-4.png') }}"
                                            alt="Banner img desc">
                                    </a>
                                    ...
                                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow"
                                        ...
                                        <div class="product text-center">
                                            <figure class="product-media">
                                                ...
                                                <a href="product.html">
                                                    <img src="{{ asset('frontend/assets/images/demos/demo-14/products/product-1.jpg') }}"
                                        ...
                                        <div class="product text-center">
                                            <figure class="product-media">
                                                <span class="product-label label-sale">Sale</span>
                                                <a href="product.html">
                                                    <img src="{{ asset('frontend/assets/images/demos/demo-14/products/product-2.jpg') }}"
                                                        alt="Product image" class="product-image">
                                                </a>
                                        ...
                                        <div class="product text-center">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="{{ asset('frontend/assets/images/demos/demo-14/products/product-3.jpg') }}"
                                                        alt="Product image" class="product-image">
                                                </a>
                                        ...
                                        <div class="product text-center">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="{{ asset('frontend/assets/images/demos/demo-14/products/product-4.jpg') }}"
                                                        alt="Product image" class="product-image">
                                                </a>
                                        ...
                                        <div class="product text-center">
                                            <figure class="product-media">
                                                ...
                                                <a href="product.html">
                                                    <img src="{{ asset('frontend/assets/images/demos/demo-14/products/product-5.jpg') }}"
                                                        alt="Product image" class="product-image">
                                                </a>
                                        ...
                                        <div class="product text-center">
                                            <figure class="product-media">
                                                <span class="product-label label-top">Top</span>
                                                <a href="product.html">
                                                    <img src="{{ asset('frontend/assets/images/demos/demo-14/products/product-6.jpg') }}"
                                                        alt="Product image" class="product-image">
                                                </a>
                                    ...
                                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow"
                                        ...
                                        <div class="product text-center">
                                            <figure class="product-media">
                                                <span class="product-label label-top">Top</span>
                                                <a href="product.html">
                                                    <img src="a{{ asset('frontend/assets/images/demos/demo-14/products/product-6.jpg') }}"
                                                        alt="Product image" class="product-image">
                                                </a>
                                        ...
                                        <div class="product text-center">
                                            <figure class="product-media">
                                                ...
                                                <div class="product-countdown" data-until="+55h"
                                ...
                                <div class="cat-banner row no-gutters">
                                    <div class="cat-banner-list col-sm-6 d-xl-none d-xxl-flex"
                                        ...
                                        <div class="banner-list-content">
                                            ...
                                            <ul>
                                                ...
                                                <li class="list-all-link"><a href="#">See All Departments</a>
                                                </li>
                                            </ul>
                                    ...
                                    <div class="col-sm-6 col-xl-12 col-xxl-6">
                                        <div class="banner banner-overlay">
                                            ...
                                            <div class="banner-content">
                                                <h4 class="banner-subtitle text-white"><a href="#">Best
                                                        Deals</a></h4><!-- End .banner-subtitle -->
                                                <h3 class="banner-title text-white"><a href="#">Canon EOS
                                                        <br>Mega Sale <br><span>Up To 20% Off</span></a></h3>
                                                <!-- End .banner-title -->
                                                <a href="#" class="banner-link">Shop Now <i
                                                        class="icon-long-arrow-right"></i></a>
                                            </div><!-- End .banner-content -->
                            ...
                            <div class="col-xl-9 col-xxl-8">
                                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow"
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{ asset('frontend/assets/images/demos/demo-14/products/product-7.jpg') }}"
                                                    alt="Product image" class="product-image">
                                            </a>
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            ...
                                            <a href="product.html">
                                                <img src="{{ asset('frontend/assets/images/demos/demo-14/products/product-8.jpg') }}"
                                                    alt="Product image" class="product-image">
                                            </a>
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="product.html">Apple - 11 Inch iPad
                                                    Pro <br>with Wi-Fi 256GB </a></h3><!-- End .product-title -->
                                            <div class="product-price">
                                                $899.99
                                            </div><!-- End .product-price -->
                                            <div class="ratings-container">
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            ...
                                            <span class="product-label label-sale">Sale</span>
                                            <a href="product.html">
                                                <img src="{{ asset('frontend/assets/images/demos/demo-14/products/product-9.jpg') }}"
                                                    alt="Product image" class="product-image">
                                            </a>
                                ...
                                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow"
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <span class="product-label label-new">New</span>
                                            <a href="product.html">
                                                <img src="{{ asset('frontend/assets/images/demos/demo-14/products/product-11.jpg') }}"
                                                    alt="Product image" class="product-image">
                                            </a>
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <span class="product-label label-sale">Sale</span>
                                            <a href="product.html">
                                                <img src="{{ asset('frontend/assets/images/demos/demo-14/products/product-12.jpg') }}"
                                                    alt="Product image" class="product-image">
                                            </a>
                                        ...
                                        <div class="product-body">
                                            ...
                                            <div class="product-nav product-nav-dots">
                                                <a href="#" class="active"
                                                    style="background: #f7f6f5;"><span class="sr-only">Color
                                                        name</span></a>
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{ asset('frontend/assets/images/demos/demo-14/products/product-13.jpg') }}"
                                                    alt="Product image" class="product-image">
                                            </a>
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <span class="product-label label-new">New</span>
                                            <a href="product.html">
                                                <img src="{{ asset('frontend/assets/images/demos/demo-14/products/product-10.jpg') }}"
                                                    alt="Product image" class="product-image">
                                            </a>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="banner banner-overlay">
                                    ...
                                    <div class="banner-content">
                                        <h4 class="banner-subtitle text-white d-none d-sm-block"><a
                                                href="#">Spring Sale is Coming</a></h4>
                                        <!-- End .banner-subtitle -->
                                        <h3 class="banner-title text-white"><a href="#">Floral T-shirts and
                                                Vests <br><span>Spring Sale</span></a></h3><!-- End .banner-title -->
                                        <a href="#" class="banner-link">Shop Now <i
                                                class="icon-long-arrow-right"></i></a>
                                    </div><!-- End .banner-content -->
                                </div><!-- End .banner -->
                            ...
                            <div class="col-md-6">
                                <div class="banner banner-overlay">
                                    ...
                                    <div class="banner-content">
                                        <h4 class="banner-subtitle text-white d-none d-sm-block"><a
                                                href="#">Amazing Value</a></h4><!-- End .banner-subtitle -->
                                        <h3 class="banner-title text-white"><a href="#">Upgrade and Save
                                                <br><span>On The Latest Apple Devices</span></a></h3>
                                        <!-- End .banner-title -->
                                        <a href="#" class="banner-link">Shop Now <i
                                                class="icon-long-arrow-right"></i></a>
                                    </div><!-- End .banner-content -->
                                ...
                                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow"
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                ...
                                                <img src="{{ asset('frontend/assets/images/demos/demo-14/products/product-14.jpg') }}"
                                                    alt="Banner img desc">
                                            </a>
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <span class="product-label label-new">New</span>
                                            <a href="product.html">
                                                <img src="{{ asset('frontend/assets/images/demos/demo-14/products/product-15.jpg') }}"
                                                    alt="Banner img desc">
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{ asset('frontend/assets/images/demos/demo-14/products/product-16.jpg') }}"
                                                    alt="Banner img desc">
                                            </a>
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{ asset('frontend/assets/images/demos/demo-14/products/product-17.jpg') }}"
                                                    alt="Banner img desc">
                                            </a>
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="product.html">Triple compartment
                                            ...
                                            <div class="product-nav product-nav-dots">
                                                <a href="#" class="active"
                                                    style="background: #f1f1f1;"><span class="sr-only">Color
                                                        name</span></a>
                                                <a href="#" style="background: #333333;"><span
                                                        class="sr-only">Color name</span></a>
                                            </div><!-- End .product-nav -->
                                    ...
                                    <div class="col-sm-6 col-xl-12 col-xxl-6">
                                        <div class="banner banner-overlay">
                                            ...
                                            <div class="banner-content">
                                                <h4 class="banner-subtitle text-white"><a href="#">Best
                                                        Deals</a></h4><!-- End .banner-subtitle -->
                                                <h3 class="banner-title text-white"><a href="#">Cooking
                                                        <br>Appliances <br><span>Up To 30% Off</span></a></h3>
                                                <!-- End .banner-title -->
                                                <a href="#" class="banner-link">Shop Now <i
                                                        class="icon-long-arrow-right"></i></a>
                                            </div><!-- End .banner-content -->
                                ...
                                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow"
                                    ...
                                    <div class="product text-center">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="product.html">Cuisinart French
                                                    Classic 3 Piece</a></h3><!-- End .product-title -->
                                            <div class="product-price">
                                                $44.99
                                            </div><!-- End .product-price -->
                                            <div class="ratings-container">
                    ...
                    <aside class="col-xl-3 col-xxl-2 order-xl-first mt-3">
                        <div class="sidebar sidebar-home mt-3">
                            <div class="row">
                                    ...
                                    <div class="widget widget-banner">
                                        <div class="banner banner-overlay">
                                            ...
                                            <div
                                                ...
                                                <h3 class="banner-title text-white"><a href="#">Maximum
                                                        Comfort <span>Sofas -20% Off</span></a></h3>
                                                <!-- End .banner-title -->
                                                <a href="#" class="banner-link">Shop Now <i
                                                        class="icon-long-arrow-right"></i></a>
                                            </div><!-- End .banner-content -->
                                ...
                                <div class="col-sm-6 col-xl-12">
                                    <div class="widget widget-banner">
                                        <div class="banner banner-overlay">
                                            ...
                                            <div class="banner-content banner-content-top">
                                                <h3 class="banner-title text-white"><a href="#">Take Better
                                                        Photos <br><span>With</span> Canon EOS <br><span>Up To 20%
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-4">
                            <div class="widget widget-about">
                                <img src="{{ asset('frontend/assets/images/demos/demo-14/logo-footer.png') }}"
                ...
                <div class="row no-gutters bg-white newsletter-popup-content">
                    <div class="col-xl-3-5col col-lg-7 banner-content-wrap">
                        <div class="banner-content text-center">
                            <img src="{{ asset('frontend/assets/images/popup/newsletter/logo.png') }}"
