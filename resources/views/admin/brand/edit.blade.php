...
@section('title', 'Brand update | Swift Shop')
                ...
                <form action="{{ route('brand.update', $brand->id) }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control text-dark"  id="name"
                            ...
                            class="@error('name') is-invalid @enderror" value="{{ $brand ? $brand->name : '' }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control text-dark"  id="slug"
                            ...
                            class="@error('slug') is-invalid @enderror" value="{{ $brand ? $brand->slug : '' }}">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control text-dark"  id="meta_title"
                            ...
                            class="@error('meta_title') is-invalid @enderror" value="{{ $brand ? $brand->meta_title : '' }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control text-dark"  id="order_level"
                            ...
                            class="@error('order_level') is-invalid @enderror" value="{{ $brand ? $brand->order_level : '' }}">
