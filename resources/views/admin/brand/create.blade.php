            ...
            <div class="col-lg-12">
                ...
                <form action="{{ route('brand.store') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control text-dark"  id="slug"
                            ...
                            class="@error('slug') is-invalid @enderror" value="{{ old('slug') }}">
              ...
              <div style="float: right" class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="Date" class="form-control text-dark"  id="action_date"
                            name="action_date" placeholder="Enter meta title"
                            class="@error('action_date') is-invalid @enderror" value="{{ old('action_date') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control text-dark"  id="meta_title"
                            ...
                            class="@error('meta_title') is-invalid @enderror" value="{{ old('meta_title') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control text-dark"  id="order_level"
                            ...
                            class="@error('order_level') is-invalid @enderror" value="{{ old('order_level') }}">
