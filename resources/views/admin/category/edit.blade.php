            ...
            <div class="col-lg-12">
                ...
                <form action="{{ route('category.update', $category->id) }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control text-dark"  id="name"
                            ...
                            class="@error('name') is-invalid @enderror" value="{{ $category ? $category->name : '' }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control text-dark"  id="slug"
                            ...
                            class="@error('slug') is-invalid @enderror" value="{{ $category ? $category->slug : '' }}">
              ...
              <div style="float: right" class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control text-dark"  id="meta_title"
                            ...
                            class="@error('meta_title') is-invalid @enderror" value="{{ $category ? $category->meta_title : '' }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control text-dark"  id="meta_icon"
                            ...
                            class="@error('meta_icon') is-invalid @enderror" value="{{ $category ? $category->meta_icon : '' }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control text-dark"  id="order_level"
                            ...
                            class="@error('order_level') is-invalid @enderror" value="{{ $category ? $category->order_level : '' }}">
              ...
              <div class="form-group">
                    ...
                    <textarea class="form-control" name="meta_keyword" id="summernote1" cols="147%" rows="10">
                        {{ $category ? $category->meta_keyword : '' }}
                    </textarea>
                </div>
